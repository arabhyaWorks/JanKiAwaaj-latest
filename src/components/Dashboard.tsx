...
import { TrendingUp, TrendingDown, Users, Newspaper, MessageCircle, MapPin, Eye, Calendar } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const socialMediaPosts = [
    {
      ...
      content: "Operation Sindoor is our commitment to clean governance and law & order in UP.",
      likes: 12000,
      shares: 3500,
      date: "2024-12-15",
      platform: "Twitter",
    ...
    },
    {
      ...
      content: "Where is the overbridge the people were promised? Empty promises won't develop Varanasi.",
      likes: 9000,
      shares: 2700,
      date: "2024-12-10",
      platform: "Twitter",
    ...
    {
      author: "Varanasi BJP",
      content: "Over 2 lakh people have benefitted from PM Awas Yojana in our constituency. Development continues!",
      likes: 6000,
      shares: 1900,
      date: "2024-12-01",
      platform: "Facebook",
  ...
  const statsCards = [
    { title: 'Total Mentions', value: '12,458', change: '+8.2%', trending: 'up', icon: MessageCircle },
    { title: 'Positive Sentiment', value: '45%', change: '+2.1%', trending: 'up', icon: TrendingUp },
    { title: 'News Articles', value: '2,847', change: '+12.5%', trending: 'up', icon: Newspaper },
    { title: 'Strong Constituencies', value: '248', change: '+5.3%', trending: 'up', icon: MapPin },
  ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-bold text-gray-800">Political Trends Analysis</h3>
            <p className="text-sm text-gray-600 mt-1">Real-time tracking of party performance and public sentiment</p>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-medium text-gray-600">Congress</span>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <p className="text-xs text-orange-700 mt-2">Strong upward momentum</p>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-600">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-800">Congress Trend</p>
            ...
            <p className="text-xs text-green-700 mt-2">Stable but low support</p>
          </div>
          ...
          <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
            ...
            <p className="text-xs text-indigo-700 mt-2">Slight decline observed</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">Overall Sentiment Analysis For BJP </h3>
            <div className="flex items-center space-x-2">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">Regional Performance</h3>
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={regionData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <defs>
                ...
                <linearGradient id="oppositionGradient" x1="0" y1="0" x2="0" y2="1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">Key Performance Areas</h3>
            <div className="text-sm text-gray-600">
              Performance Score (%)
            </div>
          </div>
          <div className="text-center mb-4">
            <p className="text-sm text-gray-600">Government Performance Metrics by Department</p>
            <p className="text-xs text-gray-500 mt-1">Each ring represents performance percentage in key governance areas</p>
          </div>
          <ResponsiveContainer width="100%" height={300}>
            <RadialBarChart cx="50%" cy="50%" innerRadius="20%" outerRadius="90%" data={performanceData}>
              ...
              <Tooltip 
                ...
                formatter={(value: number, name: string) => [`${value}%`, `${name} Performance`]}
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">Political Trends Over Time</h3>
            <div className="flex items-center space-x-1">
              <TrendingUp className="w-4 h-4 text-green-500" />
              <span className="text-sm text-green-600 font-medium">+13% this week</span>
            </div>
          </div>
          <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-800">Trending Parties In UP</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Bharatiya Janata Party</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <span>8K posts</span>
                  <span>•</span>
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Samajwadi Party</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Indian National Congress</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Bahujan Samaj Party</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Aazad Samaj Party</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <span>906 posts</span>
                  <span>•</span>
          ...
          <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h4 className="font-semibold text-gray-800">Apna Dal Sonelal</h4>
                <div className="flex items-center space-x-2 text-sm text-gray-500">
                  <span>654 posts</span>
                  <span>•</span>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-800">Trending Leaders In UP</h3>
            <div className="flex items-center space-x-2 text-sm text-gray-500">
              <span>See All</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-gray-800">Yogi Adityanath</h4>
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-gray-800">Akhilesh Yadav</h4>
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <div className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
              <div className="flex items-center space-x-4">
                ...
                />
                <div>
                  <h4 className="font-semibold text-gray-800">Chandrashekhar</h4>
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
                    <span>ASP Chief</span>
                    <span>•</span>
                    <span>MP</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            {[
              {
                id: 1,
                title: 'वाराणसी में गंगा नदी का जलस्तर लगातार बढ़ रहा है',
                views: '52.0k',
                source: 'NBT',
                time: '2hrs ago',
                tags: ['#गंगा', '#जलस्तर'],
                image: 'https://navbharattimes.indiatimes.com/photo/122224641.cms?imgsize=94316&cfs=8JL5MBsDYFNop'
              },
              {
                id: 2,
                title: 'दिव्य काशी, भव्य काशी के बोर्ड के सामने सड़क धंसी, कांग्रेस ने आरोप लगाए',
                views: '45.0k',
                source: 'NBT',
                time: '5hrs ago',
              ...
              {
                id: 3,
                title: 'बनारस में रोप-वे और सर्विस कॉरिडोर की योजना का ऐलान, कैट स्टेशन से शुरू',
                views: '38.0k',
                source: 'NBT',
                time: '28 mins ago',
                tags: ['#Railway', '#Ropeway'],
                image: 'https://navbharattimes.indiatimes.com/photo/122239641.cms?imgsize=111106&cfs=8JL5MBsDYFNo'
              },
              {
                id: 4,
                title: 'मुसलाधार बारिश: गंगा का जलस्तर तीन दिन में 3 मीटर बढ़ा',
                views: '31.0k',
                source: 'NBT',
                time: 'July 1, 2025',
                tags: ['#Weather', '#Ganga'],
                image: 'https://navbharattimes.indiatimes.com/photo/122183991.cms?imgsize=74664&cfs=8JL5MBsDYFNo'
              },
              {
                id: 5,
                title: 'मुसलाधार बारिश: गंगा का जलस्तर तीन दिन में 3 मीटर बढ़ा',
              ...
              <div key={news.id} className="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-lg transition-colors border-b border-gray-100 last:border-b-0">
                <img 
                  src={news.image} 
                  alt={news.title}
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-medium text-gray-800 text-sm leading-5 mb-2 line-clamp-2">
                    {news.title}
                  </h4>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Social Media Highlights</h3>
                      <button className="text-sm text-gray-500 hover:text-orange-600 transition-colors flex items-center space-x-1">
              <span>See All</span>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
